...
export const metadata = {
    title: "Details Page",
    description: "Hello, I am Details page."
}

const Page = async ({ params }) => {
    const details = await getServiceDetail(params.id);
    const {_id, img, description, title, price, facility} = details.res;
    return (
            ...
            <div className="my-6">
                <div className="grid grid-cols-3 gap-8">
                    ...
                    <div className="p-6 bg-gray-100">
                        <Image className="w-full object-cover h-40" src={img} alt="checkout service" width={400} height={400} />
